...
public class CoordCube {
	...
	static int cachemodelTotal=0; //TgCacheEngine
	...
	private static  <T> T load_cachetable(String key, Class<T> classOfT){
...
//		System.out.println(Thread.currentThread().getName()+" cachemodelTotal=>"+cachemodelTotal);
	...
	static short[][] twistMove = null;
	static {
		twistMove = load_cachetable("CoordCube_twistMove", short[][].class);
		if( twistMove== null ) {
			...
			dump_cachetable("CoordCube_twistMove" , twistMove);
		}
	}
	...
	// flip = 0 in phase 2.
	static short[][] flipMove = null;
	static {

		flipMove = load_cachetable("CoordCube_flipMove", short[][].class);
		if(flipMove == null) {
			...
			dump_cachetable("CoordCube_flipMove" , flipMove);
			}
	...
	static short[][] FRtoBR_Move = null;
	static {
		FRtoBR_Move = load_cachetable("CoordCube_FRtoBR_Move",short[][].class);
		if( FRtoBR_Move== null ) {
		...
		for (short i = 0; i < N_FRtoBR; i++) {
			...
			dump_cachetable("CoordCube_FRtoBR_Move" , FRtoBR_Move);
	  }
	...
	static short[][] URFtoDLF_Move = null;
	static {
		URFtoDLF_Move = load_cachetable("CoordCube_URFtoDLF_Move",short[][].class);
		if( URFtoDLF_Move == null ) {
		...
		for (short i = 0; i < N_URFtoDLF; i++) {
			...
			dump_cachetable("CoordCube_URFtoDLF_Move" , URFtoDLF_Move);
		}
	}
	...
	static short[][] URtoDF_Move = null;
	static {
		URtoDF_Move = load_cachetable("CoordCube_URtoDF_Move", short[][].class);
		if( URtoDF_Move == null) {
		...
		for (short i = 0; i < N_URtoDF; i++) {
			...
			dump_cachetable("CoordCube_URtoDF_Move" , URtoDF_Move);
		}
	...
	static short[][] URtoUL_Move = null;
	static {
		URtoUL_Move = load_cachetable("CoordCube_URtoUL_Move", short[][].class);
		if( URtoUL_Move == null ) {
		...
		for (short i = 0; i < N_URtoUL; i++) {
			...
			dump_cachetable("CoordCube_URtoUL_Move" , URtoUL_Move);
		}
	...
	static short[][] UBtoDF_Move = null;
	static {
		UBtoDF_Move = load_cachetable("CoordCube_UBtoDF_Move", short[][].class);
		if( UBtoDF_Move == null) {
		...
		for (short i = 0; i < N_UBtoDF; i++) {
			...
			dump_cachetable("CoordCube_UBtoDF_Move" , UBtoDF_Move);
	}
	}

	// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	// Table to merge the coordinates of the UR,UF,UL and UB,DR,DF edges at the beginning of phase2
	static short[][] MergeURtoULandUBtoDF = null;
	static {
		// for i, j <336 the six edges UR,UF,UL,UB,DR,DF are not in the
		// UD-slice and the index is <20160
		MergeURtoULandUBtoDF = load_cachetable("CoordCube_MergeURtoULandUBtoDF", short[][].class);
		if( MergeURtoULandUBtoDF == null ) {
		...
		for (short uRtoUL = 0; uRtoUL < 336; uRtoUL++) {
			...
			dump_cachetable("CoordCube_MergeURtoULandUBtoDF" , MergeURtoULandUBtoDF);
		}
	...
	static byte[] Slice_URFtoDLF_Parity_Prun = null;
	static {
		Slice_URFtoDLF_Parity_Prun = load_cachetable("CoordCube_Slice_URFtoDLF_Parity_Prun", byte[].class);
		if( Slice_URFtoDLF_Parity_Prun == null ) {
		...
		while (done != N_SLICE2 * N_URFtoDLF * N_PARITY) {
			...
			dump_cachetable("CoordCube_Slice_URFtoDLF_Parity_Prun" , Slice_URFtoDLF_Parity_Prun);
		}
	...
	// The pruning table entries give a lower estimation for the number of moves to reach the solved cube.
	static byte[] Slice_URtoDF_Parity_Prun = null;
	static {
		Slice_URtoDF_Parity_Prun = load_cachetable("CoordCube_Slice_URtoDF_Parity_Prun", byte[].class);
		if( Slice_URtoDF_Parity_Prun == null ) {
		...
		while (done != N_SLICE2 * N_URtoDF * N_PARITY) {
			...
			dump_cachetable("CoordCube_Slice_URtoDF_Parity_Prun" , Slice_URtoDF_Parity_Prun);
		}
	}
	...
	static byte[] Slice_Twist_Prun = null;
	static {
		Slice_Twist_Prun = load_cachetable("CoordCube_Slice_Twist_Prun", byte[].class);
		if( Slice_Twist_Prun == null ) {
		...
		while (done != N_SLICE1 * N_TWIST) {
			...
			dump_cachetable("CoordCube_Slice_Twist_Prun" , Slice_Twist_Prun);
		}
	}
	...
	// The pruning table entries give a lower estimation for the number of moves to reach the H-subgroup.
	static byte[] Slice_Flip_Prun = null;
	static {
		Slice_Flip_Prun = load_cachetable("CoordCube_Slice_Flip_Prun", byte[].class);
		if( Slice_Flip_Prun == null ) {
		...
		while (done != N_SLICE1 * N_FLIP) {
			...
			dump_cachetable("CoordCube_Slice_Flip_Prun" , Slice_Flip_Prun);
		}
	}
